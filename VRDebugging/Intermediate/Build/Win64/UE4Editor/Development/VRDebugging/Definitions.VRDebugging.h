#undef VRDEBUGGING_API
#undef VRDEBUGGING_VTABLE
...
#define UE_PROJECT_NAME VRDebugging
...
#define VRDEBUGGING_VTABLE DLLEXPORT_VTABLE
#define VRDEBUGGING_API DLLEXPORT
